...
#
# Generated by export_simulation on Sat Mar 30 13:49:06 -0400 2019
#
################################################################################
...
switch to the './rotary_encoder_0.sh' script.

./rotary_encoder_0.sh -reset_run
...
./rotary_encoder_0.sh -noclean_files

For more information on the script, please type './rotary_encoder_0.sh -help'.
