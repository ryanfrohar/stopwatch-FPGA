...
#set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { resetn }]; #IO_L24N_T3_34 Sch=sw[8]
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { updn }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
